...
class Settings:
    ...
    birefnet_model_id: str = os.getenv("SHADOWGEN_BIREFNET_MODEL_ID", "ZhengPeng7/BiRefNet")
    ...
    triton_segmenter_rmbg2_input: str = os.getenv("SHADOWGEN_TRITON_SEGMENTER_RMBG2_INPUT", "pixel_values")
    triton_segmenter_rmbg2_output: str = os.getenv("SHADOWGEN_TRITON_SEGMENTER_RMBG2_OUTPUT", "alphas")
    triton_segmenter_rmbg2_resolution: int = _as_int("SHADOWGEN_TRITON_SEGMENTER_RMBG2_RESOLUTION", 1024)
