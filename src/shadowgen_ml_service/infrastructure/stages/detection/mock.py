...
from shadowgen_ml_service.utils.images import bbox_from_mask, ensure_pil, estimate_foreground_mask


class MockDetector(Detector):
    def detect(self, stage_input: DetectionInput) -> DetectionResult:
        mask = estimate_foreground_mask(ensure_pil(stage_input.image))
