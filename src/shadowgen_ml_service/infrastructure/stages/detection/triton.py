...
from shadowgen_ml_service.infrastructure.backends.triton.serializers import image_to_nchw_float32_input, tensor_input, tensor_to_bbox, tensor_to_scalar
    ...
    def detect(self, stage_input: DetectionInput) -> DetectionResult:
        ...
        response = self.client.infer(
            ...
            inputs=[
                ...
                tensor_input(
                    self.binding.inputs["padding_px"].tensor_name,
                    [[int(stage_input.padding_px)]],
                    datatype=self.binding.inputs["padding_px"].datatype,
                ),
            ],
        )
