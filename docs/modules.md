...
- `V2-DIFF`: local diffusion backend plus preferred Triton-ready slot; current temporary contract is `img + mask -> shadow_image` without angle/elevation/softness/reflection controls
